...
function Cart() {
  ...
  function deleteProduct(id, price) {
    ...
    const idToRemove = cartList.filter((item) => item.id === id)
    setCartListTotal(
      (parseFloat(cartListTotal) - (idToRemove[0].count * parseFloat(price))).toFixed(2)
    );
    ...
    <>
      ...
      <div id="cart-container">
        <div id="cart-products-list">
          {cartList.length === 0? (<p style={{fontSize:"5vh"}}>Empty Cart</p>) : (
