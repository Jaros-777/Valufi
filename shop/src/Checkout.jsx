    ...
    <>
      ...
      <div id="checkout-container">
        ...
        <h1>Payments Method</h1>
          <p style={currentPayment === 0 ? {scale:"1.2"}: {}} onClick={(()=>setCurrentPayment(0))} >PayU </p>
          <p style={currentPayment === 1 ? {scale:"1.2"}: {}} onClick={(()=>setCurrentPayment(1))} > Przelewy24</p>
          <p style={currentPayment === 2 ? {scale:"1.2"}: {}} onClick={(()=>setCurrentPayment(2))} >Blik</p>
          <p style={currentPayment === 3 ? {scale:"1.2"}: {}} onClick={(()=>setCurrentPayment(3))} >VISA</p>
          <p style={currentPayment === 4 ? {scale:"1.2"}: {}} onClick={(()=>setCurrentPayment(4))} >MasterCard</p>
          <p style={currentPayment === 5 ? {scale:"1.2"}: {}} onClick={(()=>setCurrentPayment(5))} >Apple Pay</p>
          <p style={currentPayment === 6 ? {scale:"1.2"}: {}} onClick={(()=>setCurrentPayment(6))} >Google Pay</p>
        </div>
